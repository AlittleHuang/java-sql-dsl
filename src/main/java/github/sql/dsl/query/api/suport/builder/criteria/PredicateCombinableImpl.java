...
import github.sql.dsl.query.api.suport.builder.query.SubPredicateHeaderCombinableImpl;
...
public class PredicateCombinableImpl<T, NEXT> implements PredicateCombinable<T, NEXT> {
    ...
    public <R extends Entity> PathBuilder<T, R, NEXT> and(EntityAttribute<T, R> attribute) {
        return new PathBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, false, this::mapperNext);
    }

    @Override
    public <R extends Entity> PathBuilder<T, R, NEXT> or(EntityAttribute<T, R> attribute) {
        return new PathBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, false, this::mapperNext);
    }

    @Override
    public <R extends Entity> PathBuilder<T, R, NEXT> andNot(EntityAttribute<T, R> attribute) {
        return new PathBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, true, this::mapperNext);
    }

    @Override
    public <R extends Entity> PathBuilder<T, R, NEXT> orNot(EntityAttribute<T, R> attribute) {
        return new PathBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, true, this::mapperNext);
    }

    @Override
    public <R> PredicateBuilder<T, R, NEXT> and(Attribute<T, R> attribute) {
        return new PredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, false, this::mapperNext);
    }

    @Override
    public <R> PredicateBuilder<T, R, NEXT> or(Attribute<T, R> attribute) {
        return new PredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, false, this::mapperNext);
    }

    @Override
    public <R> PredicateBuilder<T, R, NEXT> andNot(Attribute<T, R> attribute) {
        return new PredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, true, this::mapperNext);
    }

    @Override
    public <R> PredicateBuilder<T, R, NEXT> orNot(Attribute<T, R> attribute) {
        return new PredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, true, this::mapperNext);
    }

    @Override
    public <R extends Number> NumberPredicateBuilder<T, R, NEXT> and(NumberAttribute<T, R> attribute) {
        return new NumberPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, false, this::mapperNext);
    }

    @Override
    public <R extends Number> NumberPredicateBuilder<T, R, NEXT> or(NumberAttribute<T, R> attribute) {
        return new NumberPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, false, this::mapperNext);
    }

    @Override
    public <R extends Number> NumberPredicateBuilder<T, R, NEXT> andNot(NumberAttribute<T, R> attribute) {
        return new NumberPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, true, this::mapperNext);
    }

    @Override
    public <R extends Number> NumberPredicateBuilder<T, R, NEXT> orNot(NumberAttribute<T, R> attribute) {
        return new NumberPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, true, this::mapperNext);
    }

    @Override
    public <R extends Date> ComparablePredicateBuilder<T, R, NEXT> and(ComparableAttribute<T, R> attribute) {
        return new ComparablePredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, false, this::mapperNext);
    }

    @Override
    public <R extends Date> ComparablePredicateBuilder<T, R, NEXT> or(ComparableAttribute<T, R> attribute) {
        return new ComparablePredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, false, this::mapperNext);
    }

    @Override
    public <R extends Date> ComparablePredicateBuilder<T, R, NEXT> andNot(ComparableAttribute<T, R> attribute) {
        return new ComparablePredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, true, this::mapperNext);
    }

    @Override
    public <R extends Date> ComparablePredicateBuilder<T, R, NEXT> orNot(ComparableAttribute<T, R> attribute) {
        return new ComparablePredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, true, this::mapperNext);
    }

    @Override
    public StringPredicateBuilder<T, NEXT> and(StringAttribute<T> attribute) {
        return new StringPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, false, this::mapperNext);
    }

    @Override
    public StringPredicateBuilder<T, NEXT> or(StringAttribute<T> attribute) {
        return new StringPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, false, this::mapperNext);
    }

    @Override
    public StringPredicateBuilder<T, NEXT> andNot(StringAttribute<T> attribute) {
        return new StringPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.AND, true, this::mapperNext);
    }

    @Override
    public StringPredicateBuilder<T, NEXT> orNot(StringAttribute<T> attribute) {
        return new StringPredicateBuilderSupport<>(AttributePath.exchange(attribute), Operator.OR, true, this::mapperNext);
    }
    ...
    public NEXT andAppend(Builder<T, NEXT> builder) {
        SubPredicateHeaderCombinableImpl<T, SubPredicateCombinable<T, NEXT>> r =
                new SubPredicateHeaderCombinableImpl<>(SubPredicateCombinableSupport::new);
