...
public interface SubPredicateHeaderCombinable<T, NEXT> {
    ...
    <U extends Number> NumberPredicateTester<T, U, NEXT> get(NumberAttribute<T, U> column);

    <U extends Date> ComparablePredicateTester<T, U, NEXT> get(ComparableAttribute<T, U> column);
    ...
    <U extends Number> NumberPredicateTester<T, U, NEXT> not(NumberAttribute<T, U> column);

    <U extends Date> ComparablePredicateTester<T, U, NEXT> not(ComparableAttribute<T, U> column);
